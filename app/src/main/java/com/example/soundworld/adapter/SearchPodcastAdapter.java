...
//    podcast的数据绑定
    ...
    public SearchPodcastAdapter(List<PodcastList> mpodcastList ){
        this.mpodcastList = mpodcastList;
    }

    @NonNull
    @Override
    public SearchPodcastAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        context = parent.getContext();
//        绑定对应的listpodcast
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_search_podcast,parent,false);
        return new ViewHolder(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull SearchPodcastAdapter.ViewHolder holder, int position) {
...
//        点击跳转至podcast详细界面
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View view) {
            super(view);
            title = itemView.findViewById(R.id.searchpodcast_title);
            image = itemView.findViewById(R.id.searchpodcast_image);
