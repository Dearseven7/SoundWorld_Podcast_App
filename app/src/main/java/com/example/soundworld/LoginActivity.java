...
import com.example.soundworld.Database.MyDatabaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cursor.moveToFirst()) {
                    do {
                        ...
                        if (account.equals(hadaccount) && password.equals(hadpassword)) {
                            ...
                            editor.apply();
                            Toast.makeText(LoginActivity.this, "Welcome to SoundWorld!", Toast.LENGTH_SHORT).show();
                ...
                cursor.close();
                if (flag == 1) {
                    Toast.makeText(LoginActivity.this, "Your ID and Password is not correct", Toast.LENGTH_SHORT).show();
                }
            }
        });
